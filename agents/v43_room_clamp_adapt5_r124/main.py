...
# Remap: the 21 pairs V43 sends to route 105 go to route 124 instead (see
# build_v43_room_clamp_r124.py; pilot +391 uncovered-check 0, covered +863).
_R108_SHOP_ROUTES.update({
    ('BAKERY', 'ICE_CREAM_SHOP'): 124,
    ('BRUNCH_SPOT', 'BAKERY'): 124,
    ('BRUNCH_SPOT', 'ICE_CREAM_SHOP'): 124,
    ('BRUNCH_SPOT', 'SMOOTHIE_SHOP'): 124,
    ('FARMERS_MARKET', 'PIZZA_SHOP'): 124,
    ('FARMERS_MARKET', 'SMOOTHIE_SHOP'): 124,
    ('ICE_CREAM_SHOP', 'BAKERY'): 124,
    ('ICE_CREAM_SHOP', 'BRUNCH_SPOT'): 124,
    ('ICE_CREAM_SHOP', 'FARMERS_MARKET'): 124,
    ('ICE_CREAM_SHOP', 'ICE_CREAM_SHOP'): 124,
    ('ICE_CREAM_SHOP', 'PET_CAFE'): 124,
    ('ICE_CREAM_SHOP', 'SMOOTHIE_SHOP'): 124,
    ('PET_CAFE', 'ICE_CREAM_SHOP'): 124,
    ('PET_CAFE', 'SMOOTHIE_SHOP'): 124,
    ('PIZZA_SHOP', 'BRUNCH_SPOT'): 124,
    ('PIZZA_SHOP', 'PET_CAFE'): 124,
    ('SMOOTHIE_SHOP', 'BAKERY'): 124,
    ('SMOOTHIE_SHOP', 'FARMERS_MARKET'): 124,
    ('SMOOTHIE_SHOP', 'ICE_CREAM_SHOP'): 124,
    ('SMOOTHIE_SHOP', 'PET_CAFE'): 124,
    ('SMOOTHIE_SHOP', 'PIZZA_SHOP'): 124,
})
...
_AD_CFG = {'lookahead': 5, 'items': ('WOOL', 'MILK', 'STRAWBERRY', 'MELON'), 'min_price': 2, 'classify_items': ('WOOL', 'MILK', 'STRAWBERRY', 'MELON', 'EGG', 'CARROT', 'TOMATO'), 'min_obs': 20, 'enter': 0.85, 'exit': 0.7, 'led_blackout': 6, 'skip_hours': 1}
_AD_PARAMS = {
