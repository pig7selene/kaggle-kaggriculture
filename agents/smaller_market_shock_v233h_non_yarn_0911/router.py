...
SHOP_PLANS.update({
    ('BAKERY', 'BAKERY'): 13,
    ('BAKERY', 'BRUNCH_SPOT'): 13,
    ('BAKERY', 'FARMERS_MARKET'): 13,
    ('BAKERY', 'ICE_CREAM_SHOP'): 13,
    ('BAKERY', 'PET_CAFE'): 13,
    ('BAKERY', 'PIZZA_SHOP'): 13,
    ('BAKERY', 'SMOOTHIE_SHOP'): 13,
    ('BRUNCH_SPOT', 'BAKERY'): 13,
    ('BRUNCH_SPOT', 'FARMERS_MARKET'): 13,
    ('BRUNCH_SPOT', 'PET_CAFE'): 14,
    ('BRUNCH_SPOT', 'PIZZA_SHOP'): 13,
    ('BRUNCH_SPOT', 'SMOOTHIE_SHOP'): 15,
    ('FARMERS_MARKET', 'BAKERY'): 16,
    ('FARMERS_MARKET', 'BRUNCH_SPOT'): 13,
    ('FARMERS_MARKET', 'PET_CAFE'): 13,
    ('FARMERS_MARKET', 'PIZZA_SHOP'): 13,
    ('FARMERS_MARKET', 'SMOOTHIE_SHOP'): 13,
    ('ICE_CREAM_SHOP', 'BAKERY'): 13,
    ('ICE_CREAM_SHOP', 'BRUNCH_SPOT'): 13,
    ('ICE_CREAM_SHOP', 'ICE_CREAM_SHOP'): 13,
    ('ICE_CREAM_SHOP', 'PET_CAFE'): 17,
    ('ICE_CREAM_SHOP', 'PIZZA_SHOP'): 13,
    ('ICE_CREAM_SHOP', 'SMOOTHIE_SHOP'): 17,
    ('PET_CAFE', 'BAKERY'): 13,
    ('PET_CAFE', 'BRUNCH_SPOT'): 18,
    ('PET_CAFE', 'FARMERS_MARKET'): 19,
    ('PET_CAFE', 'ICE_CREAM_SHOP'): 13,
    ('PET_CAFE', 'PET_CAFE'): 13,
    ('PET_CAFE', 'SMOOTHIE_SHOP'): 20,
    ('PIZZA_SHOP', 'BAKERY'): 13,
    ('PIZZA_SHOP', 'BRUNCH_SPOT'): 13,
    ('PIZZA_SHOP', 'FARMERS_MARKET'): 13,
    ('PIZZA_SHOP', 'ICE_CREAM_SHOP'): 13,
    ('PIZZA_SHOP', 'PET_CAFE'): 13,
    ('PIZZA_SHOP', 'PIZZA_SHOP'): 13,
    ('PIZZA_SHOP', 'SMOOTHIE_SHOP'): 13,
    ('SMOOTHIE_SHOP', 'BAKERY'): 13,
    ('SMOOTHIE_SHOP', 'BRUNCH_SPOT'): 13,
    ('SMOOTHIE_SHOP', 'ICE_CREAM_SHOP'): 13,
    ('SMOOTHIE_SHOP', 'PET_CAFE'): 13,
    ('SMOOTHIE_SHOP', 'PIZZA_SHOP'): 13,
    ('SMOOTHIE_SHOP', 'SMOOTHIE_SHOP'): 13,
})
...
class Policy:
    def __init__(self, folder):
        ...
        if len(self.tapes) != 21 or any(len(tape) != LAST_STEP + 1 for tape in self.tapes):
            raise ValueError("Expected 21 complete, 719-turn action tapes")
        self.players = {}
...
def _v233_eligible(obs,native):
    if tuple(obs['town']['unlocked_shops'][:2]) in {('BAKERY', 'BAKERY'),('BAKERY', 'BRUNCH_SPOT'),('BAKERY', 'FARMERS_MARKET'),('BAKERY', 'ICE_CREAM_SHOP'),('BAKERY', 'PET_CAFE'),('BAKERY', 'PIZZA_SHOP'),('BAKERY', 'SMOOTHIE_SHOP'),('BRUNCH_SPOT', 'BAKERY'),('BRUNCH_SPOT', 'FARMERS_MARKET'),('BRUNCH_SPOT', 'PET_CAFE'),('BRUNCH_SPOT', 'PIZZA_SHOP'),('BRUNCH_SPOT', 'SMOOTHIE_SHOP'),('FARMERS_MARKET', 'BAKERY'),('FARMERS_MARKET', 'BRUNCH_SPOT'),('FARMERS_MARKET', 'PET_CAFE'),('FARMERS_MARKET', 'PIZZA_SHOP'),('FARMERS_MARKET', 'SMOOTHIE_SHOP'),('ICE_CREAM_SHOP', 'BAKERY'),('ICE_CREAM_SHOP', 'BRUNCH_SPOT'),('ICE_CREAM_SHOP', 'ICE_CREAM_SHOP'),('ICE_CREAM_SHOP', 'PET_CAFE'),('ICE_CREAM_SHOP', 'PIZZA_SHOP'),('ICE_CREAM_SHOP', 'SMOOTHIE_SHOP'),('PET_CAFE', 'BAKERY'),('PET_CAFE', 'BRUNCH_SPOT'),('PET_CAFE', 'FARMERS_MARKET'),('PET_CAFE', 'ICE_CREAM_SHOP'),('PET_CAFE', 'PET_CAFE'),('PET_CAFE', 'SMOOTHIE_SHOP'),('PIZZA_SHOP', 'BAKERY'),('PIZZA_SHOP', 'BRUNCH_SPOT'),('PIZZA_SHOP', 'FARMERS_MARKET'),('PIZZA_SHOP', 'ICE_CREAM_SHOP'),('PIZZA_SHOP', 'PET_CAFE'),('PIZZA_SHOP', 'PIZZA_SHOP'),('PIZZA_SHOP', 'SMOOTHIE_SHOP'),('SMOOTHIE_SHOP', 'BAKERY'),('SMOOTHIE_SHOP', 'BRUNCH_SPOT'),('SMOOTHIE_SHOP', 'ICE_CREAM_SHOP'),('SMOOTHIE_SHOP', 'PET_CAFE'),('SMOOTHIE_SHOP', 'PIZZA_SHOP'),('SMOOTHIE_SHOP', 'SMOOTHIE_SHOP')}:return False
