"""Selected six-cow deadline scheduler with duplicate animal no-op suppression."""

from copy import deepcopy
from runpy import run_path


base = run_path("agents/watering_w3d_cow6_deadline.py")["agent"]
...
def agent(obs):
    ...
    for index, (position, unit_action) in enumerate(zip(positions, unit_actions)):
        ...
        invalid = (
            ...
            or (op == "COLLECT_FERTILIZER" and not tile.get("fertilizer_available", False))
